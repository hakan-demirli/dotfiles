-- Main modifier key (global, used across this file and host configs)
mainMod = "SUPER"
...
-- Variables, autostart, env, visual config, input
require("includes")
...
hl.window_rule({ name = "float-zenity", match = { class = "zenity" }, float = true }) -- wine prefix
...
hl.window_rule({ name = "ws3-surfer",      match = { title = "Surfer" },      workspace = 3 }) -- Surfer has no class
hl.window_rule({ name = "ws3-vsim",        match = { class = "Vsim" },        workspace = 3 })
hl.window_rule({ name = "ws3-windowobj",   match = { class = "WindowObj" },   workspace = 3 }) -- spawned by vsim
...
-- Suppress maximize from all apps
hl.window_rule({
