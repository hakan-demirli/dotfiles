...
QtObject {
    ...
    component MetricTokens: QtObject {
        ...
        readonly property int touchTarget: Theme.space.extraExtraLarge
        ...
        readonly property int keyboardKeyHeight: metrics.touchTarget
        readonly property int keyboardGap: Theme.space.extraSmall
        readonly property int keyboardMaximumWidth: metrics.touchTarget * 24
