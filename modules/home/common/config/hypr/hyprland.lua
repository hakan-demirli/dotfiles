...
hl.window_rule({
  name = "btop-special",
  match = { class = "kitty", title = "my_btop" },
  workspace = "special:btop",
})
hl.window_rule({
  name = "qalculate-special",
  match = { class = "qalculate%-qt" },
  float = true,
  workspace = "special:calculator",
})
hl.window_rule({
  name = "qalculate2-special",
...
hl.window_rule({
  name = "todo-special",
  match = { class = "kitty", title = "my_todo" },
  workspace = "special:todo",
})
hl.window_rule({
  name = "plan-special",
  match = { class = "kitty", title = "my_plan" },
  workspace = "special:plan",
})
...
hl.bind("ALT + N", hl.dsp.exec_cmd("todo_my.sh"))
hl.bind("ALT + Z", hl.dsp.exec_cmd("plan_my.sh"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("player_my.sh"))
...
hl.bind("XF86MonBrightnessUp", change_brightness("+"), { locked = true })
hl.bind("XF86MonBrightnessDown", change_brightness("-"), { locked = true })

hl.bind("XF86Calculator", hl.dsp.exec_cmd("true"), { locked = true })
...
hl.bind("XF86Tools", change_brightness("+"), { locked = true })
hl.bind("XF86Launch5", change_brightness("-"), { locked = true })
